package com.example.databaseconnectivityappas;
...
import com.example.databaseconnectivityappas.R;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowInfo=(Button)findViewById(R.id.btnShowInformation);
    ...
    public void onClick(View view)
    {
        ...
        if(view==btnShowInfo)
        {
            showMessage("Student Management Application", "Developed By Srinivas K");
        }
    }
